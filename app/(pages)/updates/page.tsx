	...
	},
	{
		...
		children: (
			<>
				发布 V3.1.0 版本, 小光说:
				<ul>
					<li>全新智能体界面，带来更直观、更友好的用户体验</li>
					<li>新增300+个智能体，涵盖全方位行业及生活场景</li>
					<li>智能体数量大幅增加，为用户提供更多样化的选择</li>
					<li>自定义智能体功能正在优化中，即将推出更强大的个性化设置</li>
					<li>优化了智能体列表的排序和筛选功能</li>
					<li>代码架构再次优化,为后续的智能体管理打下基础</li>
				</ul>
			</>
		),
		className: "fade-in-element",
	},
	{
		...
		children: (
			<>
				发布 V3.1.1 版本, 小光说:
				<ul>
					<li>小光AI换新logo啦！全新的视觉形象，为您带来焕然一新的体验</li>
					<li>提升了logo在各种设备和分辨率下的显示效果</li>
					<li>更新了所有相关的品牌元素，确保视觉体验的一致性</li>
				</ul>
			</>
		),
		className: "fade-in-element",
