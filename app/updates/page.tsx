...
const items = [
		...
		children: (
			<>
				...
				<ul>
					<li>
						我们重构了角色页面,
						增加了角色的分类,你可以在全部角色中进行分类筛选.
						(但深度定制的角色还没有上线).
					</li>
					<li>
						{" "}
						我们引入了小亮(开发者), 主要来帮助小光同学编写代码,
						他们会一起努力, 让小光变得更加强大.
					</li>
					<li>
						同时加入了女巫小双, 小双心中追随者小亮,
						但是小亮眼中只有小光. (佐为在天之灵感到甚是无奈) .
					</li>
					<li>
						{" "}
						其中角色等级, 代表着当前语言模型的深度定制程度. Lv1
						为较为基础模型
					</li>
					<li>其他小细节, 间距, 色调调整</li>
				</ul>
		...
		children: (
			<>
				...
				<ul>
					<li>
						我们加入了第一个超级角色, 孔老师.
						孔老师拥有极其复杂的提示词工程, 他能够根据你的性格,
						偏好, 特征, 当前学历程度进行个性化课程的定制.
					</li>
					<li>
					...
					<li>
						我们意识到原本的小光底层, 性格过于乐观单一,
						在回答的时候略显啰嗦. 我们重新对小光进行了调整,
						他由原本的lv2, 升级到了lv2.5 (lv3的中间状态),
						他的回答更加简洁, 但是也更加有趣.
					</li>
				</ul>
			</>
	...
	},
	{
		label: "2023-07-28",
		children:
			"发布 v0.5.2 版本: 公测版正式上线, 启用 https://xiaoguang.online",
		color: "red",
	},
	{
		label: "2023-07-29",
	...
	},
	{
		label: "2023-08-01",
		children:
			"发布 v0.6.1 版本: 更新了角色图标, 增加了隐藏标题栏来扩大空间",
	},
	{
		label: "2023-08-03",
		children:
	...
	},
	{
		...
		children: (
			<>
				<ul>
					<li>
						发布 v0.9 版本: 联网查询, 网页浏览, 计算器插件, Dalle
						画图
					</li>
