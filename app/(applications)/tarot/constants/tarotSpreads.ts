...
export const TAROT_SPREADS: TarotSpread[] = [
	...
	},
	{
		...
		positions: [
			...
			},
			{
				...
				name: "Choice B - Pros",
				meaning: "代表第二个选择的优势。",
				coordinates: { x: 210, y: 150 },
			},
			{
				id: 4,
				name: "Choice B - Cons",
				meaning: "代表第二个选择的劣势。",
				coordinates: { x: 210, y: 300 },
			},
			{
				id: 5,
				name: "Advice",
				meaning: "提供关于如何做出最佳决策的指导或建议。",
				coordinates: { x: 130, y: 400 },
			},
		],
		cardCount: 5,
		labels: ["优势劣势分析", "决策辅助", "二选一", "选择"],
	},
		...
		positions: [
			{
				...
				name: "Present",
				meaning: "代表当前的情况。",
				coordinates: { x: 170, y: 175 },
			},
			{
				id: 2,
				name: "Challenge",
				meaning: "代表当前面临的挑战或障碍。",
				coordinates: { x: 200, y: 175 }, // 与当前位置重叠，但通常是横向放置
			},

			{
				...
				coordinates: { x: 50, y: 175 },
			},
			{
				id: 4,
				name: "Future",
				meaning: "代表即将到来的事件。",
				coordinates: { x: 320, y: 175 },
			},
			{
				id: 5,
				name: "Above",
				meaning: "代表最佳可能的结果。",
				coordinates: { x: 170, y: 0 },
			},
			{
				id: 6,
				name: "Below",
				meaning: "代表潜意识的影响。",
				coordinates: { x: 170, y: 350 },
			},
			{
				id: 7,
				name: "Advice",
				meaning: "代表建议的行动方向。",
				coordinates: { x: 470, y: 400 },
			},
			{
				id: 8,
			...
			},
			{
				...
				meaning: "代表希望和恐惧。",
				coordinates: { x: 470, y: 100 },
			},
			{
				id: 10,
				name: "Outcome",
				meaning: "代表最终的结果。",
				coordinates: { x: 470, y: 0 },
			},
		],
		cardCount: 10,
		labels: ["综合", "爱情", "事业", "财务"],
...

	{
		...
		cardCount: 7,
		labels: ["马蹄铁", "问题", "综合", "事业", "爱情", "问题解答", "指导"],
	},
	{
